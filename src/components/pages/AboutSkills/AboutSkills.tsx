...
const AboutSkills = () => {
  return (
    <div className="h-10/12 flex-col pr-12">
      <div className="size-full rounded-2xl">
        <p className="mb-5 text-2xl">
          I learned most of my skills through <i>The Odin Project</i> course,
          and I'm still continuing to learn from it. The course has made me very
          ...
          Vitest, and Jest. I'm also comfortable with TypeScript and Tailwind
          CSS.
        </p>
