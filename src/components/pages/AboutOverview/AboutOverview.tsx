    ...
    <div className="flex h-10/12 w-full flex-col justify-between pr-12 text-2xl">
      ...
      <div>
        ...
        <p>
          ...
          makes it more rewarding. I've always enjoyed pushing myself — in fact,
          I immerse myself in challenges even in my leisure time — playing Dark
          Souls, Elden Ring, Sekiro, and the likes.
        </p>
      </div>
    </div>
  );
